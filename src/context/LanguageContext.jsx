...
const translations = {
  en: {
    ...
    dashboard: {
      ...
      settingsError: "Something went wrong. Please try again.",
  ...
  sq: {
    ...
    dashboard: {
      ...
      emailLabel: "Email",
      emailReadonly: "Adresa email nuk mund të ndryshohet.",
      securitySection: "Siguria",
      newPasswordLabel: "Fjalëkalim i Ri",
      newPasswordPlaceholder: "Shkruaj një fjalëkalim të ri",
      saveChanges: "Ruaj Ndryshimet",
      updatePassword: "Përditëso Fjalëkalimin",
      settingsSaved: "Ndryshimet u ruajtën me sukses!",
      settingsError: "Diçka shkoi keq. Provo përsëri.",
